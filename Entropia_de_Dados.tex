...
\[
    ...
    & \qquad \qquad 0,065 \cdot(-3,94)+0,042 \cdot(-4,57)+0,033 \cdot(-4,92)) \\
\]
...
\paragraph{}
\paragraph{}
 {\bfseries Conclus\~{a}o:} os dados apresentados n\~{a}o possuem alto grau de aleatoriedade. Visto que o valor da entropia dos dados est\'{a} distante do valor de entropia m\'{a}xima, pode-se ent\~{a}o concluir que os dados n\~{a}o se distribuem uniformemente.
...
\begin{figure} [h]
    \includegraphics[width=15cm, height=8cm]{entropiapy.png}
\end{figure}

Demonstra\c{c}\~{a}o do Console:
\begin{figure} [h]
    \includegraphics[width=15cm, height=5cm]{consoleentrop.png}
\end{figure}
